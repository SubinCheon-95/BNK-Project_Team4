# 🏦 BNK부산은행 예금상품 관리 시스템 1/2차 Project
...
| **프로젝트 명** | BNK부산은행 예금상품 통합 관리 시스템 |
| **배경 및 목적** | <ul><li>BNK부산은행의 예금 및 금융상품 정보를 통합 관리할 수 있는 웹·앱 서비스 구현</li><li>실제 은행 서비스 구조를 반영하여 금융 데이터 설계, 관리, 보안 흐름을 경험</li><li>디자인부터 백엔드까지 전 과정을 이해하고 협업 역량을 강화</li></ul> |
